...
public class CylinderSensor extends Sensor implements PointerSensor
{
  ...
  public SFRotation axisRotation;
  ...
  CylinderSensor ()
  {
    ...
    addField ("axisRotation", axisRotation = new SFRotation (0, 0, 1, 0), Field.F_EXPOSEDFIELD); // TODO implement functionality
  ...
  public void mouseDown (float downx, float downy, Hitpoint hit, double timestamp)
  {
    ...
    // SystemOut.println ("DragMode is set to " + dragMode_);
