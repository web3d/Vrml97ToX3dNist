...
//      SystemOut.print   (commentString);
        SystemOut.print   (OutputComment ());
        if (!eof()) SystemOut.println ("[next .wrl line " + (lineno_ - 1) + "]\n");
   ...
   */
@SuppressWarnings("deprecation")  // String.getBytes()
