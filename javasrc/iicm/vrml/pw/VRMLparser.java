...
public class VRMLparser
{
  ...
  final static HeaderInfo[] headers =
  {
    ...
    new HeaderInfo ("#X3D V3.0 utf8", 3.0f),  // X3D 2004
    new HeaderInfo ("#X3D V3.1 utf8", 3.0001f),  // X3D 2005 Amendment 1
    new HeaderInfo ("#X3D V3.2 utf8", 3.0002f),  // X3D 2006 Amendment 2
    new HeaderInfo ("#X3D V3.3 utf8", 3.0003f),  // X3D 2011 Amendment 3
  };
  ...
  private Hashtable<String,Node> nodeNames = new Hashtable<String,Node> ();
  // PROTO node names
  private Hashtable<String,ProtoNode> protoNodes = new Hashtable<String,ProtoNode> ();
  ...
  public float readHeader ()
  {
    ...
    try
    {
      ...
      //SystemOut.println ("header line read from file: " + headerline);
      if (pout.debug_)
