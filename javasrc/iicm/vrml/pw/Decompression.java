...
abstract public class Decompression
{
  ...
  public static InputStream filter (InputStream in, String tmp) throws IOException 
  {
	...
	out1.write(c);
      ...
      SystemOut.print("[Decompression] [Error] write tmp error="+e+"\n");
    }
    ...
    try
    {
      ...
      //SystemOut.println ("+ " + cmdToString (command));
      return filtered;
    }
    catch (Exception e)
    {
