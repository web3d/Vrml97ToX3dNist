...
abstract public class Field
{
  ...
  Vector<Field> receiver_ = null;  // created on demand. see addReceiver
  private boolean enableRoutes_ = true;  // allows sending of eventOuts

  // callbacks for receiveEvent
  private Vector<GotEventCallback> goteventcb_;
  public void setEventCallback (GotEventCallback cb)
  {
    if (goteventcb_ == null)
      goteventcb_ = new Vector<GotEventCallback> ();
  ...
  void writeFieldValue (PrintStream os, Hashtable<String,Node> writtenrefs)
  {
  ...
  void writeX3dFieldValue (PrintStream os, Hashtable<String,Node> writtenrefs)
  {
  ...
  abstract void writeValue (PrintStream os, Hashtable<String,Node> writtenrefs);
  ...
  abstract void writeX3dValue (PrintStream os, Hashtable<String,Node> writtenrefs);
...
//     }
  ...
  final double readFloatValue (StrTokenizer st) throws IOException
  {
    ...
    changed = true;
    // SystemOut.println ("float value: " + st.nval);
  ...
  public static String fieldNameToX3d(String name) {
    if (name.equals ("SFBool"))      return "SFBool";
    if (name.equals ("SFColor"))     return "SFColor";
    if (name.equals ("SFFloat"))     return "SFFloat";
    if (name.equals ("SFImage"))     return "SFImage";
    if (name.equals ("SFInt32"))     return "SFInt32";
    if (name.equals ("SFNode"))      return "SFNode";
    if (name.equals ("SFRotation"))  return "SFRotation";
    if (name.equals ("SFString"))    return "SFString";
    if (name.equals ("SFTime"))      return "SFTime";
    if (name.equals ("SFVec2f"))     return "SFVec2f";
    if (name.equals ("SFVec3f"))     return "SFVec3f";

    // multi valued fields (MF*)
    if (name.equals ("MFColor"))     return "MFColor";
    if (name.equals ("MFFloat"))     return "MFFloat";
    if (name.equals ("MFInt32"))     return "MFInt32";
    if (name.equals ("MFNode"))      return "MFNode";
    if (name.equals ("MFRotation"))  return "MFRotation";
    if (name.equals ("MFString"))    return "MFString";
    if (name.equals ("MFVec2f"))     return "MFVec2f";
    if (name.equals ("MFVec3f"))     return "MFVec3f";
