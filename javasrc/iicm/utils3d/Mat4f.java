...
public final class Mat4f
{
  ...
  {
    SystemOut.println ("["+mat[ 0]+", "+mat[ 1]+", "+mat[ 2]+", "+mat[ 3]+"]");
    SystemOut.println ("["+mat[ 4]+", "+mat[ 5]+", "+mat[ 6]+", "+mat[ 7]+"]");
    SystemOut.println ("["+mat[ 8]+", "+mat[ 9]+", "+mat[10]+", "+mat[11]+"]");
    SystemOut.println ("["+mat[12]+", "+mat[13]+", "+mat[14]+", "+mat[15]+"]");
  }

  public static void printMat33 (float[/*9*/] mat)
  {
    SystemOut.println("["+mat[0]+","+mat[1]+","+mat[2]+"]");
    SystemOut.println("["+mat[3]+","+mat[4]+","+mat[5]+"]");
    SystemOut.println("["+mat[6]+","+mat[7]+","+mat[8]+"]");
  }
} // Mat4f
