...
public class Quaternion
{
  ...
  public Quaternion (float[/*3*/] axis, float angle)
  {
    ...
    // SystemOut.println ("quaternion. axis: " + Vec3f.print (axis) + ", angle: " + angle +
  ...
  public final void renormalize ()
  {
    ...
    if (norm == 0.0f)
    {  // irreparable damage
      SystemOut.println ("bad quaternion. reset.");
      reset ();
    }
    else
    {
   ...
   * @param num no. of the axis (0 for x, 1 for y, 2 for z)
  ...
  public float[/*3*/] transformAxis (int num)
  {
    ...
    // SystemOut.println ("Quaternion. Rotation axis " + num + " corresponds to "
