...
//       ", viewangle: " + viewangle + ", winaspect: " + winaspect + ", hither: " + hither + ", yon: " + yon);
  ...
  public void translateVP (float x, float y, float aspect, float scale)
  {
    ...
    // SystemOut.println ("horizontal axis: " + Vec3f.print (u));
    // SystemOut.println ("vertical axis: " + Vec3f.print (v));
  ...
  {
    // SystemOut.println ("rotating " + l2r + " left-to-right, " + t2b + " top-to-bottom");
    float[] v = orientation_.transformAxis (1);  // up on viewplane
  ...
  public void rotateXYcenter (float l2r, float t2b, float[/*3*/] center)
  {
    ...
    // SystemOut.println ("combined rotation: " + Vec3f.print (axisangle) + " by " + axisangle[3]);
    ...
    // SystemOut.println ("# new camera position: " + Vec3f.print (position_));
    // float[] aa = orientation.getAxisAngle ();
    // SystemOut.println ("# new camera orientation; axis: " + Vec3f.print (aa) + ", angle: " + aa[3]);
  } // rotateXYcenter
