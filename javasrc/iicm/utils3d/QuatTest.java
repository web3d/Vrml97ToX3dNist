...
class QuatTest
{
  public static void main (String[] args)
  {
    ...
    SystemOut.println ("rotate x axis by 90� around y axis: " + Vec3f.print (result));
    result = new Quaternion (xaxis, deg90).rotatePointCenter (yaxis, zero);
    SystemOut.println ("rotate y axis by 90� around x axis: " + Vec3f.print (result));
    result = new Quaternion (zaxis, deg90).rotatePointCenter (xaxis, zero);
    SystemOut.println ("rotate x axis by 90� around z axis: " + Vec3f.print (result));
  } // main
